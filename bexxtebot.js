...
client.on('message', (channel, tags, message, self) => {
  ...
  try {
    ...
    //throw new Error('this is a test error'); //test error
    ...
    */
    ...
    // ignore if command is inactive or doesn't exist
    ...
    if (command === 'pitbull') {
      ...
      if (coinflip === 0) {
        client.say(channel, 'Dale!');
      } else {
        client.say(channel, 'Believe me, been there done that. But everyday above ground is a great day, remember that.');
      }
    }
